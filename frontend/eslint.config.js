...
export default tseslint.config(
    {
        ignores: [
            ...
            // Vendored tiptap primitives (153 files) — same exclusion tsconfig.json
            // already applies to typecheck. Not authored against these project
            // rules; relocating/rewriting them is declined scope (plan §6).
            "src/shared/editor/**",
            "node_modules/**",
            "eslint-rules/**",
        ],
