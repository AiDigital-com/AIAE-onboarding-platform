...
/**
 * Resolves cache region names from the {@link CacheNamesByClassRegistry} by fully qualified class
 * name, the collision-safe identity carried by events.
 */
public interface CacheNamesByClassService {

	/**
	 * Returns the cache region names registered for the given fully qualified class name.
	 *
