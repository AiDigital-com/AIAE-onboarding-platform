package com.aidigital.aionboarding.domain.cache.repositories;
 ...
 */
public interface CacheInvalidationEventRepository extends JpaRepository<CacheInvalidationEventEntity, Long> {
	 ...
	 */
	List<CacheInvalidationEventEntity> findByIdGreaterThanOrderByIdAsc(long sequence, Pageable pageable);
