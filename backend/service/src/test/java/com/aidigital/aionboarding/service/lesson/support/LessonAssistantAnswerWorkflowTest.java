...
class LessonAssistantAnswerWorkflowTest {
	...
	@InjectMocks
	private LessonAssistantAnswerWorkflow workflow;
	...
	void askWhenSavedConversationHasAStoredResponseId_shouldSkipMaterialPreparationAndChainOntoStoredResponseTest() {
		...
		// When:
		workflow.ask(viewer, lessonId, question, List.of(), LessonAssistantPreset.SMALL_PORTIONS);
	...
	void askResultMetadataShouldNotExposeTheProviderResponseIdToTheClientTest() {
		...
		// When:
		AskLessonResultRecord result = workflow.ask(viewer, lessonId, question, List.of(),
