...
- `external-services` — external API adapters. **MANDATORY the moment the
  ...
  **BigQuery query construction:** the Google BigQuery SDK client lives in
  ...
  `.claude/agent_docs/integrations/bigquery-query-rules.md`: one typed
...
Canonical policy: `.claude/agent_docs/testing/testing-policy.md`.
...
`.claude/agent_docs/frontend/canonical-react-frontend-rules.md`):
...
`.claude/agent_docs/auth/google-sso-clerk-blueprint.md`.
