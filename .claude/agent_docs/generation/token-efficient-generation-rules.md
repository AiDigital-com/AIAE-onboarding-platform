...
1. `CLAUDE.md` (always loaded by Replit)
2. `.claude/agent_docs/generation/first-aggregate-checklist.md`
...
5. Work from the installed project root — never paste canonical docs inline
...
1. Root structure + mandatory files (see
   `.claude/agent_docs/structure/near-production-project-structure.md`).
