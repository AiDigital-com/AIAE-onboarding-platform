...
- Elevate visual system via
  `.claude/agent_docs/frontend/elevate-design-guidelines.md`.
...
- **Plain CSS files with BEM naming** for styling — NOT CSS Modules,
  ...
  `.claude/agent_docs/frontend/bem-naming-rules.md`.
...
Follow `.claude/agent_docs/auth/google-sso-clerk-blueprint.md`.
