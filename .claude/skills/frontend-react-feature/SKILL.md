...
- Elevate design guidelines: `.claude/agent_docs/frontend/elevate-design-guidelines.md`
- BEM naming (CSS class convention): `.claude/agent_docs/frontend/bem-naming-rules.md`
- Auth blueprint: `.claude/agent_docs/auth/google-sso-clerk-blueprint.md`
- Project structure: `.claude/agent_docs/structure/near-production-project-structure.md`
