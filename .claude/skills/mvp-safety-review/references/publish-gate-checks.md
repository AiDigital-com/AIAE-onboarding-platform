...
Canonical: `.claude/agent_docs/observability/usage-logging-rules.md`.
...
Canonical: `.claude/agent_docs/testing/testing-policy.md`. Past
...
Canonical: `.claude/agent_docs/errors/error-handling-pattern.md`.
