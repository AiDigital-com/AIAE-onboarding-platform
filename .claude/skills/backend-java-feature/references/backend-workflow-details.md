...
Full layout: `.claude/agent_docs/structure/near-production-project-structure.md`
...
- BigQuery is split deliberately: the Google SDK client lives in
  ...
  `.claude/agent_docs/integrations/bigquery-query-rules.md`.
...
Full contract: `.claude/agent_docs/errors/error-handling-pattern.md`.
...
Full policy: `.claude/agent_docs/testing/testing-policy.md`.
